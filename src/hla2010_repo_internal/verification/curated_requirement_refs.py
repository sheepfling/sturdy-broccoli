...
_CURATED_REQUIREMENT_DIRECT_REFS: dict[str, dict[str, tuple[str, ...]]] = {
    "HLA1516.1-FM-4.15-001": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/federation_sync.py",),
        "positive_test_refs": (
    ...
    "HLA1516.1-FM-4.17-001": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/save_restore.py",),
        "positive_test_refs": (
    ...
    "HLA1516.1-MOM-11.1-005": {
        "implementation_refs": (
            "packages/hla2010-rti-python/src/hla2010_rti_python/mom_catalog.py",
            "src/hla2010/mom.py",
        ),
        "positive_test_refs": (
    ...
    "HLA1516.1-SUP-10.18-001": {
        "implementation_refs": (
            "packages/hla2010-rti-python/src/hla2010_rti_python/support_control.py",
    ...
    "HLA1516.1-MOM-11.3-003": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/mom_reporting.py",),
        "positive_test_refs": (
    ...
    "HLA1516.1-MOM-11.3-006": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/mom_actions.py", "packages/hla2010-rti-python/src/hla2010_rti_python/mom_reporting.py"),
        "positive_test_refs": (),
        "negative_test_refs": (
            "tests/mom/test_mom_catalog_validation_v012.py::test_rejected_mom_report_request_does_not_emit_positive_mim_report",
    ...
    "HLA1516.1-MOM-11.5-001": {
        "implementation_refs": ("hla2010/service_reporting.py", "packages/hla2010-rti-python/src/hla2010_rti_python/mom_reporting.py"),
        "positive_test_refs": (
    ...
    "HLA1516.1-MOM-11.5-003": {
        "implementation_refs": ("hla2010/service_reporting.py", "packages/hla2010-rti-python/src/hla2010_rti_python/mom_actions.py", "packages/hla2010-rti-python/src/hla2010_rti_python/mom_reporting.py"),
        "positive_test_refs": (),
        "negative_test_refs": (
            "tests/mom/test_mom_catalog_validation_v012.py::test_rejected_mom_adjustment_emits_exception_but_not_service_invocation_report",
        ),
    ...
    "HLA1516.1-OWN-7.7-002": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/ownership.py",),
        "positive_test_refs": (),
        "negative_test_refs": (
    ...
    "HLA1516.1-TM-8.2-001": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/time_services.py",),
        "positive_test_refs": (
    ...
    "HLA1516.1-TM-8.8-001": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/time_services.py", "packages/hla2010-rti-python/src/hla2010_rti_python/time_queue.py"),
        "positive_test_refs": (
            "tests/time/test_mom_mim_and_time_semantics_v010.py::test_section8_core_time_management_surface_covers_callbacks_states_and_grants",
        ),
        "negative_test_refs": (
    ...
    "HLA1516.1-TM-8.8-002": {
        "implementation_refs": ("packages/hla2010-rti-python/src/hla2010_rti_python/time_queue.py",),
        "positive_test_refs": (
            "tests/time/test_mom_mim_and_time_semantics_v010.py::test_section8_core_time_management_surface_covers_callbacks_states_and_grants",
        ),
        "negative_test_refs": (),
