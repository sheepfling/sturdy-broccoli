...
def build_verification_plan(version: str = "0.13.0") -> VerificationPlan:
    ...
    assets = (
        ...
        VerificationAsset(
            ...
            "implemented-slice",
            ("packages/hla2010-rti-python/src/hla2010_rti_python/mom_actions.py::_run_mom_service_action", "verification/mom_negative_matrix_v0_12.json"),
        ...
        VerificationAsset(
            ...
            "implemented-slice",
            (
                "packages/hla2010-rti-python/src/hla2010_rti_python/save_restore.py",
        ...
        VerificationAsset(
            ...
            "implemented-slice",
            (
                "packages/hla2010-rti-python/src/hla2010_rti_python/subscriptions.py",
        ...
        VerificationAsset(
            ...
            "implemented-slice",
            (
                "hla2010_repo_internal/verification/asset_plan.py::write_verification_assets",
                "hla2010_repo_internal/verification/asset_plan.py::write_traceability_csv",
