...
_NEGATIVE_EXECUTED_BY_METHOD: dict[str, int] = {
    ...
    "getAttributeName": 3,
    "getAvailableDimensionsForClassAttribute": 3,
    "getAvailableDimensionsForInteractionClass": 1,
    ...
    "getKnownObjectClassHandle": 2,
    "getObjectClassHandle": 3,
    "getObjectClassName": 3,
    "getObjectInstanceHandle": 2,
    "getObjectInstanceName": 2,
    "getOrderName": 1,
    "getOrderType": 1,
    "getParameterHandle": 3,
    "getParameterName": 3,
    "getRangeBounds": 4,
    "getTransportationName": 1,
    "getTransportationTypeHandle": 1,
    "joinFederationExecution": 8,
    "listFederationExecutions": 1,
    "localDeleteObjectInstance": 2,
    "modifyLookahead": 4,
    "nextMessageRequestAvailable": 1,
    "normalizeFederateHandle": 1,
...
def python_backend_handler_names() -> set[str]:
    ...
    try:
        module = importlib.import_module("hla2010_rti_python.backend")
