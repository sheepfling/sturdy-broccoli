...
_EXTRACTED_REQUIREMENTS_1516_1_CLAUSES_5_6: tuple[dict[str, Any], ...] = (
    ...
    {"requirement_id": "HLA1516.1-OM-6.21-001", "section_ref": "IEEE 1516.1-2010 §6.21", "title": "RTI shall invoke Turn Updates On For Object Instance when subscribed demand makes a published object instance attribute set newly relevant to the owning federate.", "service_group": "Object management", "linked_methods": ("turnUpdatesOnForObjectInstance", "subscribeObjectClassAttributes", "unsubscribeObjectClassAttributes"), "linked_assets": ("REQ-OM-ATTRIBUTE-RELEVANCE-001",)},
    {"requirement_id": "HLA1516.1-OM-6.21-002", "section_ref": "IEEE 1516.1-2010 §6.21", "title": "Turn Updates On For Object Instance shall carry the object instance handle, relevant attribute set, and applicable update rate designator when one is in effect.", "service_group": "Object management", "linked_methods": ("turnUpdatesOnForObjectInstance",), "linked_assets": ("REQ-OM-ATTRIBUTE-RELEVANCE-001",)},
    {"requirement_id": "HLA1516.1-OM-6.22-001", "section_ref": "IEEE 1516.1-2010 §6.22", "title": "RTI shall invoke Turn Updates Off For Object Instance when subscribed demand no longer exists for a published object instance attribute set.", "service_group": "Object management", "linked_methods": ("turnUpdatesOffForObjectInstance", "unsubscribeObjectClassAttributes", "localDeleteObjectInstance"), "linked_assets": ("REQ-OM-ATTRIBUTE-RELEVANCE-001",)},
