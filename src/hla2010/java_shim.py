"""Compatibility facade for the in-process Java-shaped RTI shim."""
from __future__ import annotations

from .testing.java_shim_backend import InProcessJavaRTIShim, ShimJavaBridge
from .testing.java_shim_factory import (
