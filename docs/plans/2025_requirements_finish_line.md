...
- Extracted runtime helper lines: 11361
...
- Largest family: misc-support (2235 lines)
...
- mom-and-switch-services: 39 methods, 1312 lines; sample=mom_request_params_by_name, mom_target_rti, mom_bool, mom_int, mom_attribute_handles, mom_text, mom_number, mom_handle_list_payload
...
- save-restore-runtime: 13 methods, 432 lines; sample=capture_federation_save_snapshot, restore_federation_save_snapshot, request_federation_save, start_federation_save, process_scheduled_save, federate_save_begun, complete_save, abort_federation_save
...
- packages/hla-backend-python2025/src/hla/backends/python2025/attribute_policy.py: object-attribute-runtime, 0 functions, 5 lines; functions=
...
- packages/hla-backend-python2025/src/hla/backends/python2025/mom_surface_mixin.py: mom-and-switch-services, 0 functions, 314 lines; functions=
...
- 2025-save-restore-lifecycle: source families=4, baseline=4008 lines/72 methods, target=packages/hla-backend-python2025/src/hla/backends/python2025/save_restore_lifecycle.py; save-restore-runtime=432 lines/13 methods, time-management-runtime=830 lines/27 methods, ownership-runtime=583 lines/11 methods, callback-delivery-and-control=2163 lines/21 methods
- 2025-ownership-proof-families: source families=3, baseline=3178 lines/45 methods, target=packages/hla-backend-python2025/src/hla/backends/python2025/ownership_runtime.py; ownership-runtime=583 lines/11 methods, save-restore-runtime=432 lines/13 methods, callback-delivery-and-control=2163 lines/21 methods
...
- 2025-ddm-default-attribute-policy: source families=4, baseline=4715 lines/135 methods, target=packages/hla-backend-python2025/src/hla/backends/python2025/ddm_default_attribute_policy.py; ddm-region-runtime=477 lines/9 methods, object-attribute-runtime=1447 lines/82 methods, interaction-routing-runtime=628 lines/23 methods, callback-delivery-and-control=2163 lines/21 methods
