...
This sub-index groups the reviewable matrices that sit between the clause maps
and the verification/evidence artifacts.

Canonical order:

1. runtime options matrix
2. backend capability matrix
3. backend conformance matrix
4. vendor traceability matrix
