...
- `hla-backend-python2025` is the main full 2025 Python RTI backend, and `hla-backend-shim` is the legacy compatibility wrapper that depends on it rather than a peer RTI lane.
