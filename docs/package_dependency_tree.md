...
- `hla-backend-python1516-2025` is the sole repo-owned IEEE 1516.1-2025 Python RTI implementation lane, and `hla-backend-shim` is a legacy compatibility shim that depends on it rather than a peer RTI lane or part of the implementation claim.
...
graph TD
    ...
    hla_backend_python1516e[hla-backend-python1516e] --> hla_backend_cpp_shim[hla-backend-cpp-shim]
    ...
    hla_backend_common[hla-backend-common] --> hla_backend_python1516_2025[hla-backend-python1516-2025]
    hla_rti_core[hla-rti-core] --> hla_backend_python1516_2025[hla-backend-python1516-2025]
    hla_rti1516_2025[hla-rti1516-2025] --> hla_backend_python1516_2025[hla-backend-python1516-2025]
    hla_transport_common[hla-transport-common] --> hla_backend_python1516_2025[hla-backend-python1516-2025]
    hla_backend_common[hla-backend-common] --> hla_backend_python1516e[hla-backend-python1516e]
    hla_rti_core[hla-rti-core] --> hla_backend_python1516e[hla-backend-python1516e]
    hla_rti1516e[hla-rti1516e] --> hla_backend_python1516e[hla-backend-python1516e]
    hla_backend_python1516_2025[hla-backend-python1516-2025] --> hla_backend_shim[hla-backend-shim]
    ...
    hla_backend_python1516e[hla-backend-python1516e] --> hla_fom_proto2025_message_test[hla-fom-proto2025-message-test]
    ...
    hla_backend_python1516e[hla-backend-python1516e] --> hla_fom_proto2025_space_lite[hla-fom-proto2025-space-lite]
    ...
    hla_backend_python1516e[hla-backend-python1516e] --> hla_fom_proto2025_time_mgmt_test[hla-fom-proto2025-time-mgmt-test]
    ...
    hla_backend_python1516_2025[hla-backend-python1516-2025] --> hla_vendor_pitch_jpype[hla-vendor-pitch-jpype]
    ...
    hla_backend_python1516_2025[hla-backend-python1516-2025] --> hla_vendor_pitch_py4j[hla-vendor-pitch-py4j]
    ...
    hla_backend_python1516e[hla-backend-python1516e] --> hla_verification[hla-verification]
...
| `hla-vendor-pitch-jpype` | `hla-rti1516e, hla-rti-core, hla-bridge-java-common, hla-bridge-java-jpype, hla-vendor-pitch, hla-backend-python1516-2025` | `-` |
| `hla-vendor-pitch-py4j` | `hla-rti1516e, hla-rti-core, hla-bridge-java-common, hla-bridge-java-py4j, hla-vendor-pitch, hla-backend-python1516-2025` | `-` |
