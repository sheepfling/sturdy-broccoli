...
- typical view tags: `2025-core`, `closeout-reporting`, `scenarios`
...
| HLA2025-FR-006 | 6.1 | 33 | Federates shall have a SOM documented according to the OMT. | `HLA2025-REQ-001`, `HLA2025-FR-001`, SOM/FOM service-usage rows in `hla_2025_requirement_depth_expansion.csv` | `docs/evidence/spec2025/traceability_matrix.json`, `requirements/2025/depth/hla_2025_requirement_depth_expansion.csv`, `requirements/2025/canonical_requirements.json` | Still a bounded documentation/evidence rule. The repo tracks SOM/SOM-usage closure through the imported depth packet and the canonical requirement catalog rather than a native runtime-only claim. |
...
- `HLA2025-FR-001` through `HLA2025-FR-010` remain umbrella rows in the
  canonical requirement catalog because their normative force is already carried by the
...
current owner doc, canonical requirement rows, child-row map, runtime tests,
