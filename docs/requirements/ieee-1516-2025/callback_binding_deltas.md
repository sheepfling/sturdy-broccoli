...
| HLA2025-BIND-JAVA-CPP-001 | Java/C++ binding split | `HLA2025-BND-001`, `HLA2025-BND-002`, `HLA2025-FI-003`, `HLA2025-FI-004` | `tests/requirements/test_2025_route_parity_matrix.py`, `tests/backends/test_standard_shim_artifacts.py`, `docs/evidence/shim_routes/route_traces` | Closed as a bounded binding-capability row: it proves adapter/runtime-capability and route-trace parity over the `python2025` runtime, not full independent Java/C++ RTI semantics. |
