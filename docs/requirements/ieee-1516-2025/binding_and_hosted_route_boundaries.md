...
Python RTI implementation lane is `hla-backend-python2025`; the Java and C++
...
- Hosted FedPro is a bounded transport/runtime slice over
  `hla-backend-python2025`; its remaining proof burden is transport-seam and
