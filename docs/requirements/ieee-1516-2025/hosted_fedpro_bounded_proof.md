...
`python-2025-fedpro-grpc`. The hosted FedPro lane is real executable evidence
...
| --- | --- | --- | --- |
| `federation_lifecycle` | `parity-covered` | `tests/transport/test_grpc_transport_2025.py`, `tests/scenarios/test_python_route_parity.py` | Hosted lifecycle covers connect/create/join/list/resign/destroy/disconnect and typed callback replay over the main `python2025` lane. |
...
- The repo does not claim that `python-2025-fedpro-grpc` is a second full RTI
  implementation lane.
