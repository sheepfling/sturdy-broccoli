...
def build_verification_plan(version: str = "0.13.0") -> VerificationPlan:
    ...
    assets = (
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §11.2", "IEEE 1516.1-2010 §11.3", "IEEE 1516.1-2010 Annex G"),
            "implemented-slice",
            (
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §11.4.1", "IEEE 1516.1-2010 §11.5"),
            "implemented-slice",
            (
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §11.3", "IEEE 1516.1-2010 §11.4.1", "IEEE 1516.1-2010 Annex G"),
            "implemented-slice",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §11.3", "IEEE 1516.1-2010 §11.4.1"),
            "implemented-slice",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §8.1", "IEEE 1516.1-2010 §8.13", "IEEE 1516.1-2010 §8.16", "IEEE 1516.1-2010 §8.18", "IEEE 1516.1-2010 §9"),
            "implemented-slice",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §4.16-§4.25", "IEEE 1516.1-2010 §8"),
            "implemented-slice",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §4", "IEEE 1516.1-2010 §5", "IEEE 1516.1-2010 §6", "IEEE 1516.1-2010 §8"),
            "implemented-smoke",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §4-§11", "IEEE 1516.1-2010 Annex G"),
            "implemented-slice",
            (
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 §11.4.1", "IEEE 1516.1-2010 Annex G"),
            "planned",
        ...
        VerificationAsset(
            ...
            ("IEEE 1516.1-2010 Java binding", "IEEE 1516.1-2010 §4-§10"),
            "gap",
