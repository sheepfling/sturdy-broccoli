...
from .time import *
from .types import *
from ._spec_impl import RTIambassador, NullFederateAmbassador
...
''')
    ...
    subprocess.run([sys.executable, '-c', 'import hla.rti1516e; from hla.rti1516e import SaveFailureReason, RTIexception, AttributeHandle; import hla.rti1516e.raw_api as r; print(hla.rti1516e.__version__, len(r.API_METADATA["RTIambassador"]))'], env={**os.environ, 'PYTHONPATH': str(OUT)}, check=True)
    # zip
