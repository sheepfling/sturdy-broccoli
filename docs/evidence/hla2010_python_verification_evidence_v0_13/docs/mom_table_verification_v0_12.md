...
| MOM adjust/request/service parameters | 1516.1-2010 §11.4.1 | Required parameters, at-least-one switch groups, request/report pairing, and representative payload datatype checks come from `hla.fom.mom_catalog`. |
