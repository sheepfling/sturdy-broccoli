...
- The real runtime matrix was verified locally with:
  - `HLA2010_CERTI_PREFIX=<repo>/.local/certi/patched/install`
  - `HLA2010_CERTI_BUILD_ROOT=<repo>/.local/certi/patched/build`
  - `HLA2010_PITCH_HOME=<repo>/third_party/pitch/PITCH-prti1516e-manual`
  - `HLA2010_PITCH_USER_HOME=<repo>/.local/pitch/user-home`
