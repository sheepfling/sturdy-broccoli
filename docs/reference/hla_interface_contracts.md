...
Generated from `packages/hla-rti1516e/src/hla/rti1516e/api_metadata.json`.
...
| `getMessageRetractionHandleFactory` | `get_message_retraction_handle_factory` | `get_message_retraction_handle_factory()` | `None` |
...
| `getRegionHandleFactory` | `get_region_handle_factory` | `get_region_handle_factory()` | `None` |
