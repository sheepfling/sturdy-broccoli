...
| Python RTI hosted | n/a | `python-grpc`, `grpc-hosted-python`, `create_rti_ambassador("python", transport={"kind": "grpc", ...})` | direct Python | `grpc` | green | [test_python_route_parity.py](../tests/scenarios/test_python_route_parity.py), [test_section8_backend_matrix.py](../tests/time/test_section8_backend_matrix.py), [test_lookahead_backend_matrix.py](../tests/time/test_lookahead_backend_matrix.py), [test_grpc_transport_python_server.py](../tests/transport/test_grpc_transport_python_server.py), [python_route_parity_matrix.md](../analysis/traceability/python_route_parity_matrix.md) | same Python backend behind a transport boundary, with parity evidence covering lifecycle, exchange, declaration, ownership, synchronization, save/restore, DDM, support services, target/radar, and time-management scenarios; remote callback polling via evoke APIs |
...
| CERTI | patched | `certi-jpype`, `java-certi-jpype` | `jpype` facade over CERTI helper/native path | `subprocess-line` | partial | [tests/vendors/README.md](../tests/vendors/README.md), [test_certi_java_profile_callbacks.py](../tests/backends/test_certi_java_profile_callbacks.py) | facade parity route |
| CERTI | patched | `certi-py4j`, `java-certi-py4j` | `py4j` facade over CERTI helper/native path | `subprocess-line` | partial | [tests/vendors/README.md](../tests/vendors/README.md), [test_certi_java_profile_callbacks.py](../tests/backends/test_certi_java_profile_callbacks.py) | facade parity route |
...
| CERTI hosted | patched | `create_rti_ambassador("certi", transport={"kind": "rest", ...})` | direct helper/native facade | `rest` / `http-json` | partial | [test_certi_backend_transport.py](../tests/backends/test_certi_backend_transport.py), [rest_transport_host.py](../packages/hla2010-rti-transport-rest/src/hla2010_rti_transport_rest/rest_transport_host.py) | route exists; explicit end-to-end scenario proof is thinner than gRPC |
| CERTI | upstream | no separate backend name | baseline-only | n/a | partial | [`./tools/vendor-green`](../tools/vendor-green), [tests/vendors/README.md](../tests/vendors/README.md), [certi_runtime_limitations.md](../packages/hla2010-rti-certi/docs/certi_runtime_limitations.md) | selected only via `HLA2010_CERTI_UPSTREAM_*`; used for attribution against patched CERTI |
...
| Portico | vendor runtime | `portico`, `portico-jpype`, `java-portico-jpype` | `jpype` | direct | install-dependent | [rti.py](../packages/hla2010-spec/src/hla2010/rti.py), [real_rti_portico.py](../packages/hla2010-rti-portico/src/hla2010_rti_portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
| Portico | vendor runtime | `portico-py4j`, `java-portico-py4j` | `py4j` | direct | install-dependent | [rti.py](../packages/hla2010-spec/src/hla2010/rti.py), [real_rti_portico.py](../packages/hla2010-rti-portico/src/hla2010_rti_portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
