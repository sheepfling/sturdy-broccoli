...
| CERTI | upstream | no separate backend name | baseline-only | n/a | partial | [vendor_runtime_smoke.sh](../scripts/ci/vendor_runtime_smoke.sh), [tests/vendors/README.md](../tests/vendors/README.md), [certi_runtime_limitations.md](../packages/hla2010-rti-certi/docs/certi_runtime_limitations.md) | selected only via `HLA2010_CERTI_UPSTREAM_*`; used for attribution against patched CERTI |
...
| Portico | vendor runtime | `portico`, `portico-jpype`, `java-portico-jpype` | `jpype` | direct | install-dependent | [rti.py](../src/hla2010/rti.py), [real_rti_portico.py](../packages/hla2010-rti-portico/src/hla2010_rti_portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
| Portico | vendor runtime | `portico-py4j`, `java-portico-py4j` | `py4j` | direct | install-dependent | [rti.py](../src/hla2010/rti.py), [real_rti_portico.py](../packages/hla2010-rti-portico/src/hla2010_rti_portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
