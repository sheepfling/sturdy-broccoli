...
| Python RTI 2025 | n/a | `python2025`, `python-2025`, `python-2025-backend` | direct Python | direct | green | [test_rti1516_2025_spec_and_shim.py](../tests/test_rti1516_2025_spec_and_shim.py), [test_2025_finish_line_snapshot.py](../tests/requirements/test_2025_finish_line_snapshot.py), [test_2025_route_parity_matrix.py](../tests/requirements/test_2025_route_parity_matrix.py) | main full `rti1516_2025` implementation lane in `hla-backend-python2025`; `test_rti1516_2025_spec_and_shim.py` is a historical filename for the main in-process `python2025` proof suite; `hla-backend-shim` remains compatibility-wrapper/import-level support rather than a separate RTI |
| Python RTI 2025 hosted | n/a | `start_2025_grpc_server(...)`, `GrpcTransport(..., schema="rti1516_2025")`, `create_rti_ambassador("python2025", transport={"kind": "grpc", ...})` | direct Python | `grpc` | green | [test_grpc_transport_2025.py](../tests/transport/test_grpc_transport_2025.py), [test_hla_factory_composition.py](../tests/test_hla_factory_composition.py), [test_2025_route_parity_matrix.py](../tests/requirements/test_2025_route_parity_matrix.py), [2025_requirements_finish_line.md](plans/2025_requirements_finish_line.md) | hosted FedPro route over the main full `hla-backend-python2025` runtime; bounded runtime slice, not a separate RTI family; remaining hosted proof is transport-seam evidence over `hla-backend-python2025`, not alternate runtime ownership; factory-level `create_rti_ambassador("python2025", transport=...)` now resolves onto the main `python2025` lane rather than a wrapper-owned route |
...
| Portico | vendor runtime | `portico`, `portico-jpype`, `java-portico-jpype` | `jpype` | direct | install-dependent | [rti.py](../packages/hla-rti1516e/src/hla/rti1516e/rti.py), [real_rti_portico.py](../packages/hla-vendor-portico/src/hla/vendors/portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
| Portico | vendor runtime | `portico-py4j`, `java-portico-py4j` | `py4j` | direct | install-dependent | [rti.py](../packages/hla-rti1516e/src/hla/rti1516e/rti.py), [real_rti_portico.py](../packages/hla-vendor-portico/src/hla/vendors/portico/real_rti_portico.py) | runtime discovery/wiring exists; no current local real-runtime evidence in this workspace |
