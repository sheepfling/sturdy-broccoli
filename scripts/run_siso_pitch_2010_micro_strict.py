...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run only the six real Pitch 2010 SISO micro rows after confirmed Pitch preflight.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path.cwd() / "artifacts" / "siso_pitch_2010_micro_strict",
    ...
    paths = write_siso_pitch_2010_micro_strict_artifacts(args.output_dir, backends=args.backends)
