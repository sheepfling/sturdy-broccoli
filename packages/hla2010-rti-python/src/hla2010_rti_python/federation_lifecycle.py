...
from hla2010.fom import standard_mim_module
from hla2010.handles import FederateHandle
from hla2010.time import TimeFactoryRegistry
from hla2010.types import FederationExecutionInformation
    ...
    def _svc_joinFederationExecution(self, *args: Any) -> FederateHandle:
        ...
        with self.engine._lock:
            ...
            if any(
                ...
                from hla2010.exceptions import FederateNameAlreadyInUse
