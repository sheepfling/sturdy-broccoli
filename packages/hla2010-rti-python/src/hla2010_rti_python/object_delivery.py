...
from hla2010.fom import validate_encoded_datatype_value
...
class _ObjectDeliveryContext(Protocol):
    ...
    def _object_matches_subscription(self, actual_class: ObjectClassHandle, subscribed_class: ObjectClassHandle) -> bool: ...
    ...
    def _extract_timestamp(self, unused: tuple[Any, ...]) -> Any | None: ...

    def _validate_tso_send_time(self, timestamp: Any | None) -> None: ...
    ...
    def _reconcile_object_attribute_scope(self, federate: FederateState, instance: ObjectInstance) -> None: ...

    def _ensure_known_object(self, federate: FederateState, instance: ObjectInstance) -> ObjectInstance | None: ...

    def _subscriber_has_region_scoped_object_interest(self, federate: FederateState, instance: ObjectInstance) -> bool: ...


if TYPE_CHECKING:
    class _ObjectDeliveryMixinBase(_ObjectDeliveryContext):
        pass
else:
    class _ObjectDeliveryMixinBase:
        pass


class PythonRTIObjectDeliveryMixin(_ObjectDeliveryMixinBase):
    ...
    def _svc_localDeleteObjectInstance(self, theObject: ObjectInstanceHandle) -> None:
        ...
        if any(self.state.handle in candidates for candidates in instance.attribute_candidates.values()):
            from hla2010.exceptions import OwnershipAcquisitionPending
        ...
        if (
            ...
            from hla2010.exceptions import FederateOwnsAttributes
