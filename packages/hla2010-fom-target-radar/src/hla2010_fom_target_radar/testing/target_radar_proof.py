...
from hla2010_fom_target_radar.scenarios import make_target_radar_factory
from hla2010_fom_target_radar.scenarios.target_radar import TrackReport, Vec3, run_target_radar_scenario
from hla2010_fom_target_radar.testing.target_radar_backend_matrix import run_target_radar_backend_matrix
    ...
    *,
    ...
    proof_result = run_target_radar_scenario(
        make_target_radar_factory(
            proof_backend,
            backend_options=dict((backend_options_by_kind or {}).get(proof_backend, {})),
        ),
