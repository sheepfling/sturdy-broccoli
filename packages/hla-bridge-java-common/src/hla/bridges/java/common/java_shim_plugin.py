...
def backend_plugins() -> tuple[RTIBackendPlugin, ...]:
    ...
    return (
        ...
        RTIBackendPlugin(
            ...
            description="Java 2010 standard shim jar through the JPype bridge.",
        ...
        RTIBackendPlugin(
            ...
            aliases=(),
            family="standard/java",
            description="Java 2010 standard shim jar through the Py4J bridge.",
        ...
        RTIBackendPlugin(
            ...
            aliases=(),
            family="standard/java",
            description="Java 2025 standard shim jar through the JPype bridge.",
        ...
        RTIBackendPlugin(
            ...
            aliases=(),
            family="standard/java",
            description="Java 2025 standard shim jar through the Py4J bridge.",
