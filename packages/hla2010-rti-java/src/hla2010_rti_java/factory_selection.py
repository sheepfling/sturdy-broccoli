...
_BRIDGE_FACTORIES: dict[str, _BridgeFactory] = {
    "jpype": _BridgeFactory(
        module_name="hla2010_rti_java_jpype.factory",
    ...
    "py4j": _BridgeFactory(
        module_name="hla2010_rti_java_py4j.factory",
    ...
    **options: Any,
    ...
    if shim_profile is not None:
        ...
        return JavaRTIDiscoveryReport(
            ...
            factory_version="0.5",
            rti_class_name="hla2010_rti_java_common.java_shim_backend.InProcessJavaRTIShim",
