# hla2010-rti-backend-common docs

This package owns backend-neutral support code used across installable HLA 2010
backend families.

Key owned surfaces:
- `hla2010_rti_backend_common.base`: core backend abstractions and recording
  helpers.
- `hla2010_rti_backend_common.conversion`: handle/value conversion and native
  handle registry support.
- `hla2010_rti_backend_common.plugin_api`: backend and transport plugin/spec
  contracts.
- `hla2010_rti_backend_common.time_management`: shared time-management helper
