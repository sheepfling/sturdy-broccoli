...
_METHOD_REFERENCE_DATA: dict[str, tuple[str, str, str]] = {   'abortFederationRestore': ('4.30', 'Federation Management', 'Abort Federation Restore service'),
    ...
    'enableAttributeScopeAdvisorySwitch': (   '10.37',
                                              'Support Services',
                                              'Enable Attribute Scope Advisory Switch service'),
    ...
    'queryInteractionTransportationType': (   '6.29',
                                              'Object Management',
                                              'Query Interaction Transportation Type service'),
    ...
    'reportInteractionTransportationType': (   '6.30',
                                               'Object Management',
                                               'Report Interaction Transportation Type service'),
    ...
    'requestFederationRestoreFailed': (   '4.25',
                                          'Federation Management',
    ...
    'startRegistrationForObjectClass': (   '5.10',
                                           'Declaration Management',
                                           'Start Registration For Object Class service'),
    ...
    'unsubscribeObjectClassAttributes': (   '5.7',
                                            'Declaration Management',
