"""Shared backend-factory helpers for the minimal demo example."""
...
def minimal_demo_fom_path() -> str:
    """Return the packaged minimal demo FOM module path."""

    return str(resources.files("hla2010_fom_minimal_demo.resources.foms").joinpath("MinimalDemoFOMmodule.xml"))


def make_minimal_demo_factory(
    backend: str,
    *,
    ...
    """Build a backend factory for the minimal demo example."""
...
__all__ = ["make_minimal_demo_factory", "minimal_demo_fom_path"]
