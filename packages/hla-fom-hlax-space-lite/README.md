...
Package-owned HLA-X SpaceLite showcase runner for the `hla2010` workspace.
...
The `hla.foms.hlax_space_lite` namespace remains the owning package root for
this showcase implementation.

The HLA-X v0.1 SpaceLite FOM XML modules remain owned by `hla-rti1516-2025`
