"""Repo-internal executable showcase scenario for HLA-X SpaceLite."""
...
def run_space_lite_showcase() -> dict[str, Any]:
    ...
    federation_name = f"HLAxSpaceLiteShowcase-{uuid.uuid4().hex[:8]}"
    lifecycle: list[str] = []
    ...
    try:
        ...
        object_class = publisher.get_object_class_handle("HLAobjectRoot.HLAx.SpaceLite.ReferenceFrame")
        attributes = {
        ...
        interaction_class = publisher.get_interaction_class_handle("HLAinteractionRoot.HLAx.SpaceLite.ReferenceFrameAnnouncement")
        parameters = {
        ...
        return {
            ...
            "lifecycle": lifecycle,
            "object_class": "HLAobjectRoot.HLAx.SpaceLite.ReferenceFrame",
            "object_instance": "EarthMJ2000EqFrame",
            "interaction_class": "HLAinteractionRoot.HLAx.SpaceLite.ReferenceFrameAnnouncement",
