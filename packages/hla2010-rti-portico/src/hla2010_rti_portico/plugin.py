...
def _discover_portico_runtime() -> BackendInfo | None:
    try:
        from hla2010_rti_portico import discover_portico_runtime
...
def _portico_jpype_backend_factory(options: dict[str, Any]):
    from hla2010_rti_java_jpype import create_jpype_backend
    from hla2010_rti_portico import discover_portico_runtime
...
def _portico_py4j_backend_factory(options: dict[str, Any]):
    ...
    from hla2010_rti_java_py4j import Py4JConfig, create_py4j_backend
    from hla2010_rti_portico import launch_portico_py4j_gateway
