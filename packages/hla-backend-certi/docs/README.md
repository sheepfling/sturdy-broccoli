...
This package owns:
- CERTI runtime integration and plugin code under `src/hla.backends.certi/`
- package-owned verification/preflight policy in `src/hla.backends.certi/testing_policy.py`
