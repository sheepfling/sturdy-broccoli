...
use against other backend routes. This note records
...
- The named compare route is `./tools/certi-easy smoke compare`.
...
| `announceSynchronizationPoint` | 4.13 | callback implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md), [test_certi_backend_callbacks.py](../../../tests/backends/test_certi_backend_callbacks.py) |
| `synchronizationPointAchieved` | 4.14 | implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `federationSynchronized` | 4.15 | callback implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md), [test_certi_backend_callbacks.py](../../../tests/backends/test_certi_backend_callbacks.py) |

## Time Management

| Service | Clause | Real CERTI status | Evidence |
|---|---:|---|---|
| `enableTimeRegulation` | 8.2 | implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `timeRegulationEnabled` | 8.3 | callback implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `enableTimeConstrained` | 8.5 | implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `timeConstrainedEnabled` | 8.6 | callback implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `timeAdvanceRequest` | 8.8 | implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `timeAdvanceRequestAvailable` | 8.9 | patched CERTI is now exercised through a subprocess timeout harness and the real matrix proves a prompt equal-GALT available-grant on the Python-facing federate surface | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
| `nextMessageRequest` | 8.10 | patched CERTI is now exercised through the same fail-fast harness and the real matrix proves earliest-queued grants with timestamp-ordered delivery on the promoted timestamped object slice | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
| `nextMessageRequestAvailable` | 8.11 | patched CERTI is now exercised through the subprocess timeout harness and the real matrix proves earliest-queued grants with timestamp-ordered delivery on the promoted timestamped object slice after fixing the RTIA `nextEventRequestAvailable(...)` success-path guard | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
| `flushQueueRequest` | 8.12 | service is exposed by the adapter; patched CERTI now reaches a real grant in the promoted no-queued baseline and the queued real-runtime slice proves timestamp-ordered delivery with an earliest-queued grant for the exercised attribute path, while the Python-facing adapter normalizes integer-time callback typing for the promoted federate surface; pristine upstream does not stay alive long enough to finish queued-FQR setup | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
| `timeAdvanceGrant` | 8.13 | callback implemented and exercised for TAR/TARA/NMR/FQR paths on the promoted patched slices | [tests/vendors/README.md](../../../tests/vendors/README.md) |
| `queryGALT` | 8.16 | patched CERTI is exercised and returns valid infinity before regulation, then the current lookahead after the current two-federate regulation/constraint setup; pristine upstream tears down the RTIA path on the first `queryGALT` | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
| `queryLITS` | 8.18 | patched CERTI is exercised and returns valid infinity before regulation, then the current lookahead after the current two-federate regulation/constraint setup; pristine upstream does not reach a stable `queryLITS` observation because the baseline collapses earlier at `queryGALT` | [tests/vendors/README.md](../../../tests/vendors/README.md), [certi_runtime_limitations.md](certi_runtime_limitations.md) |
...
| `attributeOwnershipAcquisitionNotification` | 7.7 | callback implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md), [test_certi_backend_callbacks.py](../../../tests/backends/test_certi_backend_callbacks.py) |
...
| `cancelNegotiatedAttributeOwnershipDivestiture` | 7.14 | service wired, not yet exercised end to end | [service_adapter.py](../src/hla/backends/certi/certi/service_adapter.py), [certi_smoke_helper.cpp](../../../tools/certi_smoke_helper.cpp) |
...
| `isAttributeOwnedByFederate` | 7.19 | implemented and exercised | [tests/vendors/README.md](../../../tests/vendors/README.md) |
