...
def _build_file_descriptor() -> _descriptor.FileDescriptor:
    ...
    file_proto.package = "hla2010.backends.grpc_transport"
    ...
    field.type_name = ".hla2010.backends.grpc_transport.TransportValue"
    ...
    value_field.type_name = ".hla2010.backends.grpc_transport.TransportValue"
    field = transport_struct.field.add()
    field.name = "fields"
    field.number = 1
    field.label = _descriptor.FieldDescriptor.LABEL_REPEATED
    field.type = _descriptor.FieldDescriptor.TYPE_MESSAGE
    field.type_name = ".hla2010.backends.grpc_transport.TransportStruct.FieldsEntry"
    ...
    add_oneof_field("list_value", 7, _descriptor.FieldDescriptor.TYPE_MESSAGE, ".hla2010.backends.grpc_transport.TransportList")
    add_oneof_field("struct_value", 8, _descriptor.FieldDescriptor.TYPE_MESSAGE, ".hla2010.backends.grpc_transport.TransportStruct")
    ...
    field.label = _descriptor.FieldDescriptor.LABEL_OPTIONAL
    field.type = _descriptor.FieldDescriptor.TYPE_MESSAGE
    field.type_name = ".hla2010.backends.grpc_transport.TransportError"

    service = file_proto.service.add()
    service.name = "RTITransportService"
    method = service.method.add()
    method.name = "Request"
    method.input_type = ".hla2010.backends.grpc_transport.TransportRequest"
    method.output_type = ".hla2010.backends.grpc_transport.TransportResponse"
