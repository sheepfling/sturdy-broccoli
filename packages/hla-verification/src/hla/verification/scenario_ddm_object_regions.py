...
def run_ddm_object_region_lifecycle_scenario(
    ...
    *,
    ...
    subscriber_rti.request_attribute_value_update_with_regions(object_instance, subscription_pairs, config.request_tag)
    drain_callbacks_pair(publisher_rti, subscriber_rti, loops=16)
    ...
    subscriber_rti.subscribe_interaction_class_with_regions(subscriber_interaction, {subscriber_region})
    publisher_federate.clear()
...
def run_ddm_declaration_gating_scenario(
    ...
    *,
    ...
    publisher_region = publisher_rti.create_region({publisher_dimension})
    subscriber_region = subscriber_rti.create_region({subscriber_dimension})
    publisher_rti.set_range_bounds(publisher_region, publisher_dimension, config.region_bounds)
    subscriber_rti.set_range_bounds(subscriber_region, subscriber_dimension, config.region_bounds)
    publisher_rti.commit_region_modifications({publisher_region})
    subscriber_rti.commit_region_modifications({subscriber_region})
