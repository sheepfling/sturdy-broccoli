...
_EXPLICIT_SPEC2025_ROUTE_PARITY_ROWS: tuple[Spec2025RouteParityRow, ...] = (
    ...
    _row(
        ...
        "Target/Radar time-window core, output-delivery, consumer-order, and future-exclusion proofs.",
    ),
    _row(
        "time_management",
        "python-2025-fedpro-grpc",
        ...
        "evidence, the Target/Radar output-delivery, consumer-order, and future-exclusion proofs, and pre-delivery retract.",
    ),
    _row(
        "time_management",
        "java-standard-2025-jpype",
