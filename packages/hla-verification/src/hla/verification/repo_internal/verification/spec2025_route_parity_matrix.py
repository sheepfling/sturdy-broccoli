...
_EXPLICIT_SPEC2025_ROUTE_PARITY_ROWS: tuple[Spec2025RouteParityRow, ...] = (
    ...
    _row(
        ...
        "plain object/interaction subscriber-routing rollback, time/switch-control rollback, saved lookahead recovery, "
        "transport/order policy rollback, and pre-save queued-TSO redelivery after restore.",
    ),
    _row(
        "save_restore",
        "python-2025-fedpro-grpc",
