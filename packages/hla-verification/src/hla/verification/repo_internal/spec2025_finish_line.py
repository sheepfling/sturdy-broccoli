...
IMPLEMENTED_EVIDENCE_SLICES: tuple[Mapping[str, Any], ...] = (
    ...
    },
    {
        ...
        "supported_scope": (
            ...
            "to joined federates with service reporting enabled. The Python 2025 shim also routes synchronization "
            "point MOM request/report interactions through receiveInteraction callbacks. The FedPro hosted route "
            "also reports standard MIM "
            "data for HLArequestMIMdata, FOM module data for HLArequestFOMmoduleData, and object "
