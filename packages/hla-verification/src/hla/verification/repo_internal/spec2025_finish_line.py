...
IMPLEMENTED_EVIDENCE_SLICES: tuple[Mapping[str, Any], ...] = (
    ...
    },
    {
        ...
        "supported_scope": (
            ...
            "FOM module data, and synchronization point MOM request/report interactions through receiveInteraction "
            "callbacks. The FedPro hosted route also reports standard MIM "
