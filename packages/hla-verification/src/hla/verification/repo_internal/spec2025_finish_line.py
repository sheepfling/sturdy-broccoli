...
IMPLEMENTED_EVIDENCE_SLICES: tuple[Mapping[str, Any], ...] = (
    ...
    },
    {
        ...
        "supported_scope": (
            ...
            "reporting MOM adjust interactions plus exposed HLAsetSwitches adjust interactions through "
            "receiveInteraction callbacks, and routes declaration-management MOM service actions through the "
            ...
            "lookahead service paths plus supported object-management and ownership MOM service actions through "
            "normal delete, transportation-change, and ownership-divestiture service paths. The FedPro hosted route also reports standard MIM data for "
