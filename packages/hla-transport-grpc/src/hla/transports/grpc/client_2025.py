...
_COMMAND_REQUESTS: Mapping[str, str] = {
    ...
    "GET_AUTOMATIC_RESIGN_DIRECTIVE": "getAutomaticResignDirectiveRequest",
    "GET_AUTO_PROVIDE_SWITCH": "getAutoProvideSwitchRequest",
    "GET_ADVISORIES_USE_KNOWN_CLASS_SWITCH": "getAdvisoriesUseKnownClassSwitchRequest",
    "GET_ALLOW_RELAXED_DDM_SWITCH": "getAllowRelaxedDDMSwitchRequest",
    "GET_DIMENSION_HANDLE": "getDimensionHandleRequest",
    "GET_DELAY_SUBSCRIPTION_EVALUATION_SWITCH": "getDelaySubscriptionEvaluationSwitchRequest",
    ...
    "GET_NON_REGULATED_GRANT_SWITCH": "getNonRegulatedGrantSwitchRequest",
