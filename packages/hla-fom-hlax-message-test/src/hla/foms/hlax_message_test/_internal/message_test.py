"""Repo-internal executable showcase scenario for HLA-X MessageTest."""
...
def run_message_test_showcase() -> dict[str, Any]:
    ...
    federation_name = f"HLAxMessageTestShowcase-{uuid.uuid4().hex[:8]}"
    lifecycle: list[str] = []
    ...
    try:
        ...
        object_class = publisher.get_object_class_handle("HLAobjectRoot.HLAx.MessageTest.TestSuite")
        attributes = {
        ...
        interaction_class = publisher.get_interaction_class_handle("HLAinteractionRoot.HLAx.MessageTest.SendStimulus")
        parameters = {
        ...
        return {
            ...
            "lifecycle": lifecycle,
            "object_class": "HLAobjectRoot.HLAx.MessageTest.TestSuite",
            "object_instance": "EchoProtocolSmokeSuite",
            "interaction_class": "HLAinteractionRoot.HLAx.MessageTest.SendStimulus",
