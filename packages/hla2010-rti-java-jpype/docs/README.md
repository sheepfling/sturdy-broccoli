# hla2010-rti-java-jpype docs

This package owns the installable generic JPype Java bridge used by vendor
backend packages.

Key owned surfaces:
- `hla2010_rti_java_jpype.runtime`: JPype runtime and JVM attachment helpers.
- `hla2010_rti_java_jpype.adapter`: the generic JPype-backed RTI backend
  adapter.
- `hla2010_rti_java_jpype.factory` and `.plugin`: bridge factory and generic
