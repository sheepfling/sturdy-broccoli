...
def backend_plugins() -> tuple[RTIBackendPlugin, ...]:
    return (
        RTIBackendPlugin(
            ...
            family="standard/cpp",
            supports=("rti1516e",),
            description="C++ 2010 standard shim artifact through the pybind route.",
        ...
        RTIBackendPlugin(
            ...
            family="standard/cpp",
            supports=("rti1516e",),
            description="C++ 2010 standard shim artifact through the gRPC route.",
        ...
        RTIBackendPlugin(
            ...
            description="C++ 2025 standard shim artifact through the pybind route.",
            create_backend=lambda request: create_cpp_standard_backend("pybind", request),
        ...
        RTIBackendPlugin(
            ...
            family="standard/cpp",
            supports=("rti1516_2025",),
            description="C++ 2025 standard shim artifact through the gRPC route.",
            create_backend=lambda request: create_cpp_standard_backend("grpc", request),
