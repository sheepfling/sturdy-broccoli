...
Package-owned Proto2025 TimeMgmtTest showcase runner for the `hla2010` workspace.
...
The `hla.foms.proto2025_time_mgmt_test` namespace remains the owning package root
for this showcase implementation.

The Proto2025 v0.1 TimeMgmtTest FOM XML modules remain owned by
