...
This package owns:
- shared Pitch runtime discovery and launch policy under `src/hla2010_rti_pitch_common/`
- package-owned verification/preflight policy in `src/hla2010_rti_pitch_common/testing_policy.py`
