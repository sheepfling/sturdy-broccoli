"""Logical time and logical time interval abstractions for IEEE 1516.1-2010.

Sources: Java hla/rti1516e/time/*.java and C++ RTI/time/*.h.
"""
...
class LogicalTimeFactoryFactory(Protocol):
    @staticmethod
    def getLogicalTimeFactory(name: str = "") -> LogicalTimeFactory | None: ...

    @staticmethod
    def getAvailableLogicalTimeFactories() -> set[LogicalTimeFactory]: ...
