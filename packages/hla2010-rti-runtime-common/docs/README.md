# hla2010-rti-runtime-common docs
...
Key owned surfaces:
- `hla2010_rti_runtime_common.factory`: backend discovery, backend creation,
  and transport registration helpers.
- `hla2010_rti_runtime_common.real_rti_process`: subprocess lifecycle and
