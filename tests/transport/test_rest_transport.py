...
def test_rest_transport_polling_contract_drains_buffered_callbacks():
    ...
    try:
        ...
        publisher.createFederationExecution("RestPollingContractFederation", [fom], "HLAfloat64Time")
        publisher.joinFederationExecution("Publisher", "ProbeFederate", "RestPollingContractFederation")
        subscriber.joinFederationExecution("Subscriber", "ProbeFederate", "RestPollingContractFederation")
        ...
        obj = publisher.registerObjectInstance(publisher_class, "BufferedRestObject-1")
        ...
        subscriber.resignFederationExecution(ResignAction.NO_ACTION)
        publisher.resignFederationExecution(ResignAction.DELETE_OBJECTS)
        publisher.destroyFederationExecution("RestPollingContractFederation")
        subscriber.disconnect()
        publisher.disconnect()
    finally:
        if subscriber is not None:
