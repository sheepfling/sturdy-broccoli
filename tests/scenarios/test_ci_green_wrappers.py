...
def test_github_ci_local_all_mode_runs_every_lane_family_in_order(tmp_path: Path) -> None:
    ...
    lane_names = [
        ...
        "PROBE_REVIEW_PITCH_TIME_WINDOW_PROBE",
        "PROBE_REVIEW_PITCH_TIME_WINDOW_RESTORE_STATE_PROBE",
        ...
        "VENDOR_SMOKE_VALIDATE_PITCH_TIME_WINDOW_PROBE",
        "VENDOR_SMOKE_PITCH_TIME_WINDOW_PROBE",
        "VENDOR_SMOKE_VALIDATE_PITCH_TIME_WINDOW_RESTORE_STATE_PROBE",
        "VENDOR_SMOKE_PITCH_TIME_WINDOW_RESTORE_STATE_PROBE",
...
""",
    ...
    expected_suffixes = [
        ...
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "time_window and python1516_2025"],
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "save_restore and python1516_2025"],
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "ownership and python1516_2025"],
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "callback and python1516_2025"],
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "support_service and python1516_2025"],
        ["-m", "pytest", "-q", "tests/test_rti1516_2025_python2025_runtime.py", "-k", "mom and python1516_2025"],
