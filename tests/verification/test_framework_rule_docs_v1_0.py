...
def test_framework_docs_capture_product_set_scope_and_source_policy():
    ...
    assert "IEEE 1516-2010 (2010 edition)`: framework and rules" in hierarchy
    assert "IEEE 1516.1-2010 (2010 edition)`: RTI services and MOM behavior" in hierarchy
    assert "IEEE 1516.2-2010 (2010 edition)`: OMT schema language and FOM/MIM interchange" in hierarchy
