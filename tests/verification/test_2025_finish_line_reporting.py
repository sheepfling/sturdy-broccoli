...
def test_2025_finish_line_snapshot_keeps_scope_counts_and_open_work_honest() -> None:
    ...
    owner_sources = snapshot["owner_sources"]
    assert owner_sources["canonical_requirements"] == "requirements/2025/canonical_requirements.json"
    assert owner_sources["backend_resolution"] == "requirements/2025/backend_resolution.json"
    assert any(
        value == "requirements/2025/harmonization/hla_2025_requirement_disposition_ledger.csv"
        for value in owner_sources.values()
    )
    ...
    assert disposition["projection_source"].endswith("hla_2025_requirement_disposition_ledger.csv")
    ...
    assert "backend or route truth still belongs to requirements/2025/backend_resolution.json" in disposition["current_assessment"]
