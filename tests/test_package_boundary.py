...
INTERNAL_PACKAGE_SOURCE_ROOTS = {
    ...
    "hla2010-rti-java": ROOT / "packages/hla2010-rti-java/src",
...
PACKAGE_NAMESPACE_CASES = {
    ...
    "hla2010-rti-java": "hla2010_rti_java",
...
LIGHTWEIGHT_SPLIT_PACKAGE_CASES = {
    ...
    "hla2010_rti_java": {"manifest_name": "hla2010-rti-java", "forbidden_prefixes": ("hla2010_rti_certi", "hla2010_rti_pitch_", "hla2010_rti_portico")},
...
INTERNAL_IMPORT_ROOT_TO_PACKAGE = {
    ...
    "hla2010_rti_java": "hla2010-rti-java",
