...
def test_2025_route_parity_matrix_keeps_java_and_cpp_behavior_unpromoted() -> None:
    ...
    assert "Target/Radar output-delivery, consumer-order, pipeline-two-scans, and future-exclusion proofs" in rows[("time_management", "python-2025-fedpro-grpc")].notes
