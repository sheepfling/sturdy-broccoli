...
def test_2025_finish_line_snapshot_keeps_scope_counts_and_open_work_honest() -> None:
    ...
    assert "time-window core, output-delivery, consumer-order, and future-exclusion proofs" in route_rows[("time_management", "python-2025-inprocess")]["notes"]
    ...
    assert "Target/Radar output-delivery, consumer-order, and future-exclusion proofs" in route_rows[("time_management", "python-2025-fedpro-grpc")]["notes"]
    ...
    assert "output-delivery, consumer-order, and future-exclusion proofs" in milestone_rows[("python-2025-fedpro-grpc", "lookahead_windows")]["summary"]
...
def test_2025_finish_line_snapshot_names_only_implemented_slices_with_evidence() -> None:
    ...
    assert "future-exclusion, output-delivery, consumer-order, and time-window proof" in markdown
