...
def test_requirement_document_title_lookups_resolve_spec_aliases_and_bindings() -> None:
    source = _sample_source()
    assert requirement_document_title_for_alias("HLA1516.1-2025", source.to_mapping()) == "IEEE 1516.1-2025"
    assert requirement_document_title_for_alias("HLA1516.2", source.to_mapping()) == "IEEE 1516.2-2010 (2010 edition)"
    assert requirement_document_title_for_binding("federate_interface", source.to_mapping()) == "IEEE 1516.1-2025"
...
def test_requirement_document_match_helpers_follow_aliases_and_active_bindings() -> None:
    ...
    assert requirement_document_matches_binding("IEEE 1516.1-2025", "federate_interface", source.to_mapping())
