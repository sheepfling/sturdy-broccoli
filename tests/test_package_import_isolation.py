...
OWNED_PREFIX_TO_PACKAGE = {
    ...
    "hla.backends.python2025": "hla-backend-python2025",
    "hla.backends.cpp_shim": "hla-backend-cpp-shim",
...
ALLOWED_PACKAGE_DEPENDENCIES: dict[str, set[str]] = {
    ...
    "hla-vendor-pitch-jpype": {"hla-rti1516e", "hla-bridge-java-common", "hla-bridge-java-jpype", "hla-rti-core", "hla-vendor-pitch", "hla-backend-python2025"},
    "hla-vendor-pitch-py4j": {"hla-rti1516e", "hla-bridge-java-common", "hla-bridge-java-py4j", "hla-rti-core", "hla-vendor-pitch", "hla-backend-python2025"},
