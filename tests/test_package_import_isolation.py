...
ALLOWED_PACKAGE_DEPENDENCIES: dict[str, set[str]] = {
    ...
    "hla-backend-cpp-shim": {"hla-rti1516e", "hla-rti1516-2025", "hla-backend-common", "hla-backend-inmemory", "hla-backend-shim", "hla-rti-core"},
    "hla-backend-certi": {"hla-rti1516e", "hla-backend-common", "hla-rti-core", "hla-transport-common"},
    "hla-bridge-java-common": {"hla-rti1516e", "hla-rti1516-2025", "hla-backend-common", "hla-backend-shim", "hla-rti-core"},
