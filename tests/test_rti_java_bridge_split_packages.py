...
def test_split_java_jpype_package_exports_generic_bridge_surface():
    from hla2010.backends.jpype import JPypeConfig as OldRootConfig
    from hla2010.backends.jpype.factory import create_jpype_backend as old_root_create_backend
    ...
    assert OldRootConfig is JPypeConfig
    assert OldPitchConfig is JPypeConfig
    assert old_root_create_backend is create_jpype_backend
    assert old_pitch_create_backend is create_jpype_backend


def test_split_java_py4j_package_exports_generic_bridge_surface():
    from hla2010.backends.py4j import Py4JConfig as OldRootConfig
    from hla2010.backends.py4j.factory import create_py4j_backend as old_root_create_backend
    ...
    assert OldRootConfig is Py4JConfig
    assert OldPitchConfig is Py4JConfig
    assert old_root_create_backend is create_py4j_backend
