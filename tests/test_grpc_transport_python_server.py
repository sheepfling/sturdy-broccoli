...
def _start_grpc_pair():
    ...
    left_server = start_python_rti_grpc_server(engine=engine)
    right_server = start_python_rti_grpc_server(engine=engine)
...
def test_grpc_transport_can_host_python_rti_exchange_end_to_end():
    ...
    try:
        ...
        config = TwoFederateExchangeConfig(
            federation_name="GrpcHostedPythonFederation",
            ...
            object_instance_name="GrpcHostedObject-1",
