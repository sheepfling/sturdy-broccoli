...
def test_hlax_2025_example_foms_drive_two_federate_exchange(
    ...
    federation_name = f"hlax-{scenario}-{uuid.uuid4().hex[:8]}"
    ...
    assert received[2] == b"hlax-example-interaction"
