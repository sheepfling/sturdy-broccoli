...
ALLOWED_INTERNAL_DEPENDENCIES: dict[str, set[str]] = {
    ...
    "hla-backend-python2025": {"hla-backend-common", "hla-rti1516-2025", "hla-rti-core", "hla-transport-common"},
    "hla-backend-shim": {"hla-backend-python2025", "hla-rti1516-2025", "hla-rti-core"},
    ...
    "hla-backend-cpp-shim": {"hla-rti1516e", "hla-rti1516-2025", "hla-rti-core", "hla-backend-common", "hla-backend-inmemory"},
    "hla-rti-core": set(),
    ...
    "hla-verification": {"hla-rti1516e", "hla-rti1516-2025", "hla-backend-common", "hla-backend-inmemory", "hla-backend-cpp-shim", "hla-bridge-java-common", "hla-fom-target-radar", "hla-fom-proto2025-message-test", "hla-fom-proto2025-space-lite", "hla-fom-proto2025-time-mgmt-test", "hla-rti-core"},
