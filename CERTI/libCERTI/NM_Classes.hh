...
class CERTI_EXPORT NM_Attribute_Ownership_Release_Denied : public NM_Attribute_Ownership_Base {
public:
    NM_Attribute_Ownership_Release_Denied();
    virtual ~NM_Attribute_Ownership_Release_Denied() = default;
