...
NM_Attribute_Ownership_Release_Denied::NM_Attribute_Ownership_Release_Denied()
{
    this->messageName = "NM_Attribute_Ownership_Release_Denied";
    this->type = NetworkMessage::Type::ATTRIBUTE_OWNERSHIP_RELEASE_DENIED;
}
...
NetworkMessage* NM_Factory::create(NM_Type type) throw (NetworkError ,NetworkSignal) { 
    ...
    switch (type) {
        ...
        case NetworkMessage::Type::ATTRIBUTE_OWNERSHIP_RELEASE_RESPONSE:
            ...
            break;
        case NetworkMessage::Type::ATTRIBUTE_OWNERSHIP_RELEASE_DENIED:
            msg = new NM_Attribute_Ownership_Release_Denied();
            break;
