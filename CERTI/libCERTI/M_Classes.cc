// Generated on 2026 June Sat, 06 at 12:04:49 by the CERTI message generator
#include <string>
#include <vector>
...
M_Attribute_Ownership_Release_Denied::M_Attribute_Ownership_Release_Denied()
{
    this->messageName = "M_Attribute_Ownership_Release_Denied";
    this->type = Message::ATTRIBUTE_OWNERSHIP_RELEASE_DENIED;
}

void M_Attribute_Ownership_Release_Denied::serialize(libhla::MessageBuffer& msgBuffer)
{
    // Call parent class
    Super::serialize(msgBuffer);
    // Specific serialization code
...
void M_Attribute_Ownership_Release_Denied::deserialize(libhla::MessageBuffer& msgBuffer)
{
    // Call parent class
    Super::deserialize(msgBuffer);
    // Specific deserialization code
...
const ObjectHandle& M_Attribute_Ownership_Release_Denied::getObject() const
{
    return object;
}

void M_Attribute_Ownership_Release_Denied::setObject(const ObjectHandle& newObject)
{
    object = newObject;
}

uint32_t M_Attribute_Ownership_Release_Denied::getAttributesSize() const
{
    return attributes.size();
}

void M_Attribute_Ownership_Release_Denied::setAttributesSize(uint32_t num)
{
    attributes.resize(num);
}

const std::vector<AttributeHandle>& M_Attribute_Ownership_Release_Denied::getAttributes() const
{
    return attributes;
}

const AttributeHandle& M_Attribute_Ownership_Release_Denied::getAttributes(uint32_t rank) const
{
    return attributes[rank];
}

AttributeHandle& M_Attribute_Ownership_Release_Denied::getAttributes(uint32_t rank)
{
    return attributes[rank];
}

void M_Attribute_Ownership_Release_Denied::setAttributes(const AttributeHandle& newAttributes, uint32_t rank)
{
    attributes[rank] = newAttributes;
}

void M_Attribute_Ownership_Release_Denied::removeAttributes(uint32_t rank)
{
    attributes.erase(attributes.begin() + rank);
}

std::ostream& operator<<(std::ostream& os, const M_Attribute_Ownership_Release_Denied& msg)
{
    os << "[M_Attribute_Ownership_Release_Denied - Begin]" << std::endl;
    
    os << static_cast<const M_Attribute_Ownership_Release_Denied::Super&>(msg); // show parent class
    ...
    os << "[M_Attribute_Ownership_Release_Denied - End]" << std::endl;
    return os;
}
...
Message* M_Factory::create(M_Type type) throw (NetworkError ,NetworkSignal) { 
    ...
    switch (type) {
        ...
        case Message::Type::ATTRIBUTE_OWNERSHIP_RELEASE_RESPONSE:
            ...
            break;
        case Message::Type::ATTRIBUTE_OWNERSHIP_RELEASE_DENIED:
            msg = new M_Attribute_Ownership_Release_Denied();
            break;
