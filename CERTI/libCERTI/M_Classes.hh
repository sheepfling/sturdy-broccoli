...
class CERTI_EXPORT M_Attribute_Ownership_Release_Denied : public Message {
public:
    M_Attribute_Ownership_Release_Denied();
    virtual ~M_Attribute_Ownership_Release_Denied() = default;
    ...
    using Super = Message;
    friend std::ostream& operator<<(std::ostream& os, const M_Attribute_Ownership_Release_Denied& msg);
