...
void RTI1516ambassador::Private::executeService(Message* req, Message* rep)
{
    ...
    std::cerr << "[certi1516e] executeService send begin type=" << req->getMessageName() << std::endl;
    ...
    std::cerr << "[certi1516e] executeService send complete type=" << req->getMessageName() << std::endl;

    Debug(D, pdDebug) << "waiting RTIA reply." << std::endl;
    std::cerr << "[certi1516e] executeService receive begin type=" << req->getMessageName() << std::endl;
    ...
    std::cerr << "[certi1516e] executeService receive complete type=" << req->getMessageName() << std::endl;
...
void RTI1516ambassador::Private::processException(Message* msg)
{
    ...
    std::cerr << "[certi1516e] processException type=" << static_cast<int>(msg->getExceptionType()) << " reason='"
              << (msg->getExceptionReason() ? msg->getExceptionReason() : "") << "'" << std::endl;
