...
#define BASIC_CASE(MessageType, MessageClass)                                                                          \
    ...
    switch (request.message()->getMessageType()) {
        ...
        BASIC_CASE(ATTRIBUTE_OWNERSHIP_RELEASE_DENIED, NM_Attribute_Ownership_Release_Denied);
...
Responses MessageProcessor::process(MessageEvent<NM_Negotiated_Attribute_Ownership_Divestiture>&& request)
{
    ...
    my_auditServer.setLevel(AuditLine::Level(6));
    std::cerr << "[rtig-ownership] negotiate-divestiture federate=" << request.message()->getFederate()
              << " federation=" << request.message()->getFederation() << " object=" << request.message()->getObject()
              << " attributes=" << request.message()->getAttributesSize() << " tag='"
              << request.message()->getLabel() << "'" << std::endl;
    ...
    responses = my_federations.searchFederation(FederationHandle(request.message()->getFederation()))
                    .negotiateDivestiture(request.message()->getFederate(),
                                          ...
                                          request.message()->getAttributes(),
                                          request.message()->getLabel());
    std::cerr << "[rtig-ownership] negotiate-divestiture responses=" << responses.size() << std::endl;
...
Responses MessageProcessor::process(MessageEvent<NM_Attribute_Ownership_Acquisition>&& request)
{
    ...
    my_auditServer.setLevel(AuditLine::Level(6));
    std::cerr << "[rtig-ownership] acquisition federate=" << request.message()->getFederate()
              << " federation=" << request.message()->getFederation() << " object=" << request.message()->getObject()
              << " attributes=" << request.message()->getAttributesSize() << " tag='"
              << request.message()->getLabel() << "'" << std::endl;
    ...
    my_federations.searchFederation(FederationHandle(request.message()->getFederation()))
        .acquire(request.message()->getFederate(),
                 ...
                 request.message()->getAttributes(),
                 request.message()->getLabel());
    std::cerr << "[rtig-ownership] acquisition complete" << std::endl;
...
Responses MessageProcessor::process(MessageEvent<NM_Attribute_Ownership_Release_Response>&& request)
{
    ...
    my_auditServer.setLevel(AuditLine::Level(6));
    std::cerr << "[rtig-ownership] release-response federate=" << request.message()->getFederate()
              << " federation=" << request.message()->getFederation() << " object=" << request.message()->getObject()
              << " attributes=" << request.message()->getAttributesSize() << std::endl;
...
Responses MessageProcessor::process(MessageEvent<NM_Attribute_Ownership_Release_Denied>&& request)
{
    Responses responses;

    my_auditServer.setLevel(AuditLine::Level(6));
    std::cerr << "[rtig-ownership] release-denied federate=" << request.message()->getFederate()
              << " federation=" << request.message()->getFederation() << " object=" << request.message()->getObject()
              << " attributes=" << request.message()->getAttributesSize() << std::endl;
    ...
    my_federations.searchFederation(FederationHandle(request.message()->getFederation()))
        .denyRelease(request.message()->getFederate(), request.message()->getObject(), request.message()->getAttributes());
    std::cerr << "[rtig-ownership] release-denied complete" << std::endl;

    Debug(D, pdDebug) << "Federate " << request.message()->getFederate() << " of Federation "
                      << request.message()->getFederation() << " release denied of object "
                      << request.message()->getObject() << endl;

    auto rep = make_unique<NM_Attribute_Ownership_Release_Denied>();
    rep->setFederate(request.message()->getFederate());
    rep->setObject(request.message()->getObject());
...
Responses MessageProcessor::process(MessageEvent<NM_Cancel_Attribute_Ownership_Acquisition>&& request)
{
    ...
    my_auditServer.setLevel(AuditLine::Level(6));
    std::cerr << "[rtig-ownership] cancel-acquisition federate=" << request.message()->getFederate()
              << " federation=" << request.message()->getFederation() << " object=" << request.message()->getObject()
              << " attributes=" << request.message()->getAttributesSize() << std::endl;
    ...
    my_federations.searchFederation(FederationHandle(request.message()->getFederation()))
        .cancelAcquisition(
            request.message()->getFederate(), request.message()->getObject(), request.message()->getAttributes());
    std::cerr << "[rtig-ownership] cancel-acquisition complete" << std::endl;
