...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.23-002 | not-yet-tested | extracted-requirement | RTI shall support Request Attribute Transportation Type Change for the currently implemented reliable and best-effort transport subset. |
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.23-003 | not-yet-tested | extracted-requirement | RTI shall persist selected attribute transportation overrides across restore in the currently implemented reliable and best-effort transport subset. |
...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.24-004 | not-yet-tested | extracted-requirement | RTI shall route Confirm Attribute Transportation Type Change only to the federate that requested the change in the currently implemented reliable and best-effort transport subset. |
...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.26-004 | not-yet-tested | extracted-requirement | RTI shall route Report Attribute Transportation Type only to the federate that issued the corresponding query in the currently implemented reliable and best-effort transport subset. |
...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.27-002 | not-yet-tested | extracted-requirement | RTI shall support Request Interaction Transportation Type Change for the currently implemented reliable and best-effort transport subset. |
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.27-003 | not-yet-tested | extracted-requirement | RTI shall persist selected interaction transportation overrides across restore in the currently implemented reliable and best-effort transport subset. |
...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.28-004 | not-yet-tested | extracted-requirement | RTI shall route Confirm Interaction Transportation Type Change only to the federate that requested the change in the currently implemented reliable and best-effort transport subset. |
...
| IEEE 1516.1-2010 (2010 edition) | 6 | HLA1516.1-OM-6.30-004 | not-yet-tested | extracted-requirement | RTI shall route Report Interaction Transportation Type only to the federate that issued the corresponding query in the currently implemented reliable and best-effort transport subset. |
