...
This audit projects the canonical 2010 requirement catalog plus the canonical backend-resolution companion onto `certi` so every row has an explicit generated `certi` disposition.
