...
| --- | --- | --- | ---: |
| python | passed |  | 7 |
| certi | failed | create_rti_ambassador() takes 0 positional arguments but 1 was given | 0 |
| pitch-jpype | failed | create_rti_ambassador() takes 0 positional arguments but 1 was given | 0 |
| pitch-py4j | failed | create_rti_ambassador() takes 0 positional arguments but 1 was given | 0 |
