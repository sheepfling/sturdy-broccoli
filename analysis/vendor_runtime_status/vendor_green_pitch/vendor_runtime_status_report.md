...
- exit code: `1`
- artifact dir: `/private/var/folders/v8/h5gvd6pd54x7vhtkwqh5s34w0000gn/T/pytest-of-rick/pytest-2053/test_vendor_green_fails_strict0/preflight`

## Vendors

| Vendor | Classification | Environment | Exit | Blocked Reason | Artifact | Note |
| --- | --- | --- | ---: | --- | --- | --- |
| pitch | environment-blocked | docker-blocked | 1 | docker | /private/var/folders/v8/h5gvd6pd54x7vhtkwqh5s34w0000gn/T/pytest-of-rick/pytest-2053/test_vendor_green_fails_strict0/preflight/pitch-preflight.json | host/runtime prerequisites are blocked on this surface |
