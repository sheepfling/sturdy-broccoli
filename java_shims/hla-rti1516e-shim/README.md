...
small service subset used by `hla2010.testing.scenarios.run_basic_federate_scenario`:
...
unit tests use the in-process Java-shaped shim in `hla2010.testing.java_shim`.
