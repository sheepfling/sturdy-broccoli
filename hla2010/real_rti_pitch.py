...
from .backends.jpype import JPypeConfig
from .java_runtime import discover_java_tool, ensure_java_home
from .real_rti_process import RuntimeProcess
    ...
    *,
    ...
    try:
        if _wait_for_process_boot is None or _wait_for_tcp_listener is None:
            from .real_rti_process import wait_for_process_boot as _default_wait_for_process_boot
            from .real_rti_process import wait_for_tcp_listener as _default_wait_for_tcp_listener
